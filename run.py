...
# VS Bachelor
def vr_interface(swarm_size = 10, disaster_size = 4, move = "false"):
    cmds = ['-name VR_Interface{}'.format(swarm_size) + ' -size ' + str(swarm_size) + ' -d_size ' + str(disaster_size) + ' -d_move True -exp_type unity_network -run_time 100000 -op_x 300 -op_y 300']
    return cmds
